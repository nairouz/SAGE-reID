...
from SAGE_reID.utils.model_utils import print_params, state_dict_cleaner, compute_cluster_entropy_and_weights
...
def main_worker(args):
    ...
    initial_weights = state_dict_cleaner(initial_weights)
